    ...
    context: {
      sections: {
        banner: {
          ...
          text_content:
            ' VoxEditor is the first software that allows you to create your own voxel models, rig them and animate them in no time.'
        },
        others: [
          {
            id: 'modeling-tools',
            ...
            description:
              'Make the most of your creativity with a robust set of tools. If you are an advanced 3D modeler or just starting out, with our super user-friendly interface you will creating amazing stuff right away.',
            features: [
          ...
          },
          {
            ...
            description:
              'A game changer in the voxel world. With our own Skeleton System, VoxEditor allows you to rig and animate anything that you want using the timeline with a super easy to use keyframing mode.',
            features: [
